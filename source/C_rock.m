 function [rhocp,C] = C_rock(T,Mtyp,rhom,cpm0,phi,phi_i,phi_u,dphiudT)

% Finds the volumetric heat capacity of rocks and soils at temperature T.
...
%   cpm0    = mineral specific heat at 20 C             (vector)
%   phi     = porosity                                  (vector)
...
% find component heat capacities
 ...
 rhocpm = C_mineral(T,Mtyp,rhom,cpm0);  % matrix minerals
 rhocpi = C_ice(T);                     % ice
